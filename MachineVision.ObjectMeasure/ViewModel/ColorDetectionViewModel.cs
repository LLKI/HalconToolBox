...
{
    public class ColorDetectionViewModel: NavigationViewModel
    {
        public ColorDetectionViewModel(ColorDetectionService service)
        {
            Service = service;
        ...
        public ColorDetectionService Service { get; }
